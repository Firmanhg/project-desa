      ...
      <section className="pt-32 pb-20 bg-green-900 text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg text-gray-200 max-w-3xl mx-auto">
            Mengenal lebih dekat Desa Karang Jaya,
      ...
      <section className="py-24 bg-[#f8f6f1]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            Desa Karang Jaya merupakan salah satu desa yang berada
            di Kabupaten Lampung Selatan. Desa ini memiliki potensi
            besar pada sektor pertanian, perkebunan, wisata alam,
            dan komoditas unggulan yang menjadi sumber penghidupan
            masyarakat setempat.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-[#f8f6f1] p-10 rounded-3xl">
              ...
              <p className="text-gray-700 leading-relaxed">
                Mewujudkan Desa Karang Jaya yang maju,
                mandiri, sejahtera, dan berdaya saing melalui
                pengembangan potensi wisata serta komoditas lokal.
              </p>
            </div>
            ...
            <div className="bg-[#f8f6f1] p-10 rounded-3xl">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li>• Mengoptimalkan potensi komoditas unggulan.</li>
                <li>• Meningkatkan kualitas pelayanan masyarakat.</li>
                <li>• Mendorong pembangunan berkelanjutan.</li>
              </ul>
            </div>
